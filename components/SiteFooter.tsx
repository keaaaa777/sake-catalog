    ...
    <footer className="relative z-10 border-t border-gold/15 bg-[#030914] px-6 py-10 text-sm text-washi/50">
      <div className="mx-auto flex max-w-4xl flex-col items-center gap-4 text-center">
        <nav className="flex flex-wrap justify-center gap-x-6 gap-y-2">
          ...
          <Link href="/classification" className="hover:text-gold">特定名称から探す</Link>
          <Link href="/compare" className="hover:text-gold">銘柄を比較する</Link>
          <Link href="/data" className="hover:text-gold">データで見る日本酒</Link>
