...
const SEARCHED_KEYWORDS = [
  ...
  '如空', '龍泉', '安倍取水', '呉春',
  // 有名銘柄名(追加分・手薄な都道府県を補強 第11弾)
  '東薫', '鍋店', '岩の井', '木戸泉', '上総鶴', '分福', '春鶯囀', '甲斐男山',
  '芳水', '六調子', '潜龍', '東長', '力士 日本酒', '直実', '明神 日本酒',
  '天覧山', '金重', '一慶', '越生若竹', '武蔵鶴', '帝松', '文楽 日本酒',
  '花陽浴 純米', '力正宗', '天覧山 純米',
  // 有名銘柄名(追加分・手薄な都道府県を補強 第12弾:愛知・滋賀)
  '義左衛門', '長珍', '澤田酒造', '蓬左', '知多虎', '奥三河', '生道井',
  '福千歳', '喜楽長', '香の泉', '浅茅生', '不老泉', '美冨久', '千代鶴',
  '國盛', '柳蔭', '徳川家康 日本酒', '関娘',
  // 有名銘柄名(追加分・手薄な都道府県を補強 第13弾:茨城・栃木・群馬・岐阜・三重・大阪)
  '花の井', '男体山', '若盛', '相国', '桔梗', '天下野', '関の井', '常山 日本酒',
  '長良川', '奥飛騨 日本酒', '鈿女', '三重錦', '瀧自慢', '早春', '仁勇',
  // 有名銘柄名(追加分・第14弾)
  '射美', '小左衛門', '若鶴', '成政', '羽根屋', '勲碧', '車坂', '御通',
  '喜多方', '飛騨', '奥飛騨', '山廃仕込み 純米', '長生舞', '波の音', '天狗舞 大吟醸',
  // 有名銘柄名(追加分・第15弾:三重・奈良・岩手・東京・徳島 手薄補強)
  '田光', '半田 日本酒', '寒紅梅', '瑞泉 日本酒', '真名鶴', '篠峯', '廣喜',
  '磐乃井', '岩手誉', '千代菊', '喜正', '金婚 日本酒', '高尾 日本酒',
  '瓢太閤', '阿波24', '穀良都', '芳水 純米',
  // 有名銘柄名(追加分・第16弾:1000件到達に向けて)
  '田光 純米', '喜正 大吟醸', '磐乃井 大吟醸', '真名鶴 純米', '篠峯 純米吟醸',
  '寒紅梅 純米', '瓢太閤 純米', '長珍 純米大吟醸', '國盛 大吟醸', '澤田酒造 大吟醸',
  // 有名銘柄名(追加分・第17弾:1銘柄のみの蔵元の分類バリエーション補強)
  '国稀 特別純米', '楯野川 純米吟醸', '郷乃誉 特別純米', '鳳凰美田 純米大吟醸',
  '梵 純米吟醸', '醸し人九平次 純米吟醸', '作 純米吟醸', '玉乃光 純米',
  'みむろ杉 純米吟醸', '梅乃宿 純米', '紀土 特別純米', '日本城 純米',
  '獺祭 純米吟醸', '船中八策 純米大吟醸', '美丈夫 純米', '花の香 純米吟醸',
  '千代の園 純米吟醸', '千徳 純米吟醸',
  // 有名銘柄名(追加分・第18弾:1000件到達ラストスパート)
  '千歳鶴 純米吟醸', '一ノ蔵 純米吟醸', '郷乃譽 純米吟醸', '龍神 純米',
  '聖 純米大吟醸', '招德 純米大吟醸', '國乃長 純米', '稲田姫 純米吟醸',
  '李白 純米大吟醸', '王祿 純米',
  // 有名銘柄名(追加分・第19弾:1000件到達ラストスパート2)
  '楯野川 純米', '郷乃譽 純米大吟醸', '鳳凰美田 純米大吟醸', '梵 純米大吟醸原酒',
  '一ノ蔵無鑑査 純米',
  // 有名銘柄名(追加分・第20弾:1000件到達ラストスパート3)
  '甲子 特別純米', '総乃寒菊 特別純米', '多満自慢 純米吟醸', '江戸開城 純米',
  '天青 純米大吟醸', '松みどり 純米', '銀盤 大吟醸', '笑四季 純米吟醸',
  '御代栄 特別純米', '英勲 純米大吟醸', '片野桜 特別純米', '黒松白鹿 特別純米',
  '福寿 特別純米', '風の森 純米吟醸', '日本城 特別純米', '稲田姫 特別純米',
  '李白 特別純米', '十旭日 特別純米', '極聖 純米吟醸',
]
